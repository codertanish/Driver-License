...
label_id = Label(root, text = "10 Digit ID")
label_name = Label(root, text = "Driver Name")
label_dob = Label(root, text = "MM/DD/YYYY")
label_pin = Label(root, text = "6 Digit Pin")
label_address = Label(root, text = "Current Residence")
label_vehicle_type = Label(root, text = "Car Types Authorized")
...
label_vehicle_type_tag = canvas.create_text(50,180, font=('Times', '12', 'bold') ,text="Authorization: ")
...
def update():
    ...
    address = "Bob Drive, New York, United States"
    print(type(address))
    
    vehicle_type = "2 Wheel and 4 Wheel"
...
button1 = Button(root, text = "View Details", command = update)
...
label_vehicle_no_window = canvas.create_window(200, 180, anchor=CENTER, window=label_vehicle_type)
canvas.pack()
